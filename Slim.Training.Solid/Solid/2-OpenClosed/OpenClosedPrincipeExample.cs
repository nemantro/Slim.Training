using Slim.Training.Solid.Solid._2_OpenClosed.BadImplementation;
using Slim.Training.Solid.Solid._2_OpenClosed.GoodImplementation;

namespace Slim.Training.Solid.Solid._2_OpenClosed;
